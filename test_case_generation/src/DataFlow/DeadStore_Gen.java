...
public class DeadStore_Gen {
	
	public String filepath;
	public List<String> deadStoreList = new ArrayList<String>();
	...
	public void getDeadStoreInform(String filepath) {
		this.filepath = filepath; 
		String command = "clang-tidy " + filepath + " -checks=clang-analyzer-deadcode.DeadStores";
