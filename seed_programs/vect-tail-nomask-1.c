...
void __attribute__((noinline)) test_citer(int *__restrict__ a, int *__restrict__ b, int *__restrict__ c) {
  int i;
...
void __attribute__((noinline)) test_viter(int *__restrict__ a, int *__restrict__ b, int *__restrict__ c, int size) {
  int i;
...
void __attribute__((noinline)) init_data(int *__restrict__ a, int *__restrict__ b, int *__restrict__ c, int size) {
