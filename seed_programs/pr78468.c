...
void t1(int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, void *p, int align) {
...
void t2(int x0, int x1, int x2, int x3, int x4, int x5, int x6, int x7, void *p, int align, int dummy) {
  xx = x0 + x1 + x2 + x3 + x4 + x4 + x6 + x7;
  if ((int)(uintptr_t)p & (align - 1)) {
    abort();
  }
