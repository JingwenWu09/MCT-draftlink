...
static int regula_falsa(int order, double *coef, double a, double b, double *val) {
  int its;
...
int sbisect(int np, polynomial *sseq, double min_value, double max_value, int atmin, int atmax, double *roots) {
  double mid;
  int n1, n2, its, atmid;
