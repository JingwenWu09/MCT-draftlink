...
__attribute__((noinline)) void foo(double d0, double d1, double d2, double d3, double d4, double d5, double d6, double d7, float f0, float f1, float f2, float f3, char *p) {
