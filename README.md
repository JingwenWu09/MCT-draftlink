...
We also distinguish the interaction process using different boxes: "Me" represents our bug report submission, while "Developer" represents the responses from the developers of the respective model checkers. Note that the program submitted in the bug report is the reduced version of the original program, and the detailed reduction process is given in our submission. 
