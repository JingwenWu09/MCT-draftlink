...
typedef enum { _PyTime_ROUND_FLOOR = 0, _PyTime_ROUND_CEILING = 1 } _PyTime_round_t;
...
_PyTime_t __attribute__((noinline, noclone)) _PyTime_AsMicroseconds(_PyTime_t t, _PyTime_round_t round) {
