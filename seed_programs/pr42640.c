...
int main() {
  ...
  if (rr_node[0].a != rr_node[1].a || rr_node[2].a != rr_node[3].a || rr_node[1].a != 1 || rr_node[0].b != rr_node[1].b || rr_node[2].b != rr_node[3].b || rr_node[1].b != 2 || rr_node[0].c != 0 || rr_node[1].c != 1 || rr_node[2].c != 0 || rr_node[3].c != 1) {
    abort();
  }
