...
} wv6 = {{8, 9, 2, 4, '\x10', 67426805U, 1047191860L}, 1366022414UL, 858, 1, 1, 305, {1069379046L}, (int *)358273621U, {3318.041978}};
...
static union at6 callee_af6(struct et6 ap6, double bp6, long long int cp6, int dp6) {
  if (!(wv6.mv6.av6 == ap6.mv6.av6)) {
    abort();
  }
  if (!(wv6.mv6.bv6 == ap6.mv6.bv6)) {
    abort();
  }
  if (!(wv6.mv6.cv6 == ap6.mv6.cv6)) {
    abort();
  }
  if (!(wv6.mv6.dv6 == ap6.mv6.dv6)) {
    abort();
  }
  if (!(wv6.mv6.ev6 == ap6.mv6.ev6)) {
    abort();
  }
  if (!(wv6.mv6.fv6 == ap6.mv6.fv6)) {
    abort();
  }
  if (!(wv6.mv6.gv6 == ap6.mv6.gv6)) {
    abort();
  }
  if (!(wv6.nv6 == ap6.nv6)) {
    abort();
  ...
  if (!(wv6.sv6.hv6 == ap6.sv6.hv6)) {
    abort();
  }
  if (!(wv6.tv6 == ap6.tv6)) {
    abort();
  }
  if (!(wv6.uv6.kv6 == ap6.uv6.kv6)) {
    abort();
  }
  if (!(xv6 == bp6)) {
    abort();
...
static unsigned char callee_af7(float ap7, double bp7, union ct7 cp7, struct et7 dp7, union ft7 ep7, int fp7, struct gt7 gp7, long int hp7[1], long long int ip7) {
  if (!(vv7 == ap7)) {
    abort();
  }
  if (!(wv7 == bp7)) {
  ...
  if (!(yv7.kv7.iv7 == dp7.kv7.iv7)) {
    abort();
  }
  if (!(yv7.kv7.jv7 == dp7.kv7.jv7)) {
    abort();
  }
  if (!(yv7.mv7 == dp7.mv7)) {
    abort();
