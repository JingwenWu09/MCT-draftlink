...
void f(void *, struct s1 *, const union u0 *, W, W, W) __attribute__((__noinline__));
...
int main() {
  ...
  if (s.m1[0].i != (W)uv || s.m1[1].i != 0 || s.m1[2].i != 999 || s.m1[3].i != 777 || uv[0].i != 111 || uv[1].i != 222 || uv[2].i != 0 || uv[3].i != 444) {
    abort();
  }
  exit(0);
}
