...
static void do_ret_di(void) {
  if (__sync_val_compare_and_swap(AL + 0, 0x100000002ll, 0x1234567890ll) != 0x100000002ll) {
    abort();
  }
  ...
  if (__sync_val_compare_and_swap(AL + 4, 0x000000002ll, 0x1234567890ll) != 0x100000002ll) {
    abort();
  }
  if (__sync_val_compare_and_swap(AL + 5, 0x100000000ll, 0x1234567890ll) != 0x100000002ll) {
    abort();
  }
