...
void __attribute__((noinline)) test1(void *q, int x) {
  ...
  if (x < 0 ? __builtin_object_size(r, 1) != sizeof(a.a) - 9 : __builtin_object_size(r, 1) != sizeof(a.c) - 1)
    ;
#else
...
#ifdef __builtin_object_size
  if (x < 6 ? __builtin_object_size(r, 1) != sizeof(a.a) - 1 : __builtin_object_size(r, 1) != sizeof(a.a) - 6)
    ;
#else
  ...
  if (__builtin_object_size(r, 1) != 2 * 16 && __builtin_object_size(r, 1) != 30) {
    ;
  }
#endif
  if (x < 20) {
