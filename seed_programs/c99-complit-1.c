...
int main(void) {
  ...
  *i1a = 0;
  ...
  if (s0->a != 1 || s0->b != 2 || s1->a != 1 || s1->b != 2 || s2->a != 1 || s2->b != 2) {
    abort();
  }
  s0->a = 2;
  s1->b = 1;
  if (s0->a != 2 || s0->b != 2 || s1->a != 1 || s1->b != 1 || s2->a != 1 || s2->b != 2) {
    abort();
  }
  ...
  if (a0[0] != 1 || a0[1] != 2 || a0[2] != 3 || a1[0] != 1 || a1[1] != 2 || a1[2] != 3) {
    abort();
  }
  a0[0] = 3;
  if (a0[0] != 3 || a0[1] != 2 || a0[2] != 3 || a1[0] != 1 || a1[1] != 2 || a1[2] != 3) {
    abort();
  }
