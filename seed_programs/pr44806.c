...
static int di_ent_equal(void const *x, void const *y) {
  ...
  if (a.u.di4.mode == DI_MODE_4) {
    return (a.u.di4.short_ino == b.u.di4.short_ino && a.u.di4.mapped_dev == b.u.di4.mapped_dev);
  }

  if (a.u.di8.mode == DI_MODE_8) {
    return (a.u.di8.short_ino == b.u.di8.short_ino && a.u.di8.mapped_dev == b.u.di8.mapped_dev);
  }
