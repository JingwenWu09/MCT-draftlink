...
{
  if (!(wv6.mv6.av6 == ap6.mv6.av6))  abort();
  if (!(wv6.mv6.bv6 == ap6.mv6.bv6))  abort();
  if (!(wv6.mv6.cv6 == ap6.mv6.cv6))  abort();
  if (!(wv6.mv6.dv6 == ap6.mv6.dv6))  abort();
  if (!(wv6.mv6.ev6 == ap6.mv6.ev6))  abort();
  if (!(wv6.mv6.fv6 == ap6.mv6.fv6))  abort();
  if (!(wv6.mv6.gv6 == ap6.mv6.gv6))  abort();
  if (!(wv6.nv6 == ap6.nv6))  abort();
  if (!(wv6.ov6 == ap6.ov6))  abort();
  if (!(wv6.pv6 == ap6.pv6))  abort();
  if (!(wv6.qv6 == ap6.qv6))  abort();
  if (!(wv6.rv6 == ap6.rv6))  abort();
  if (!(wv6.sv6.hv6 == ap6.sv6.hv6))  abort();
  if (!(wv6.tv6 == ap6.tv6))  abort();
  if (!(wv6.uv6.kv6 == ap6.uv6.kv6))  abort();
  if (!(xv6 == bp6))  abort();
  if (!(yv6 == cp6))  abort();
  if (!(zv6 == dp6))  abort();
  return vv6;
            ...
            long long int ip7)
{
  if (!(vv7 == ap7))  abort();
  if (!(wv7 == bp7))  abort();
  if (!(yv7.kv7.iv7 == dp7.kv7.iv7))  abort();
  if (!(yv7.kv7.jv7 == dp7.kv7.jv7))  abort();
  if (!(yv7.mv7 == dp7.mv7))  abort();
  if (!(yv7.nv7 == dp7.nv7))  abort();
  if (!(yv7.ov7 == dp7.ov7))  abort();
  if (!(yv7.pv7 == dp7.pv7))  abort();
  if (!(zv7.qv7 == ep7.qv7))  abort();
  if (!(bav7 == fp7))  abort();
  if (!(bbv7.tv7 == gp7.tv7))  abort();
  if (!(bcv7[0] == hp7[0]))  abort();
  if (!(bdv7 == ip7))  abort();
  return uv7;
}
