...
public class WhileStatement {
	...
	private WhileStatement parentWhileStmt = null;
	...
	private List<WhileStatement> whileList = new ArrayList<WhileStatement>();
	
	public WhileStatement() {
		// TODO Auto-generated constructor stub
	}
	
	public WhileStatement(int startLine, int endLine, int astStartLine) {
	...
	public void setParentWhileStmt(WhileStatement parentWhileStmt) {
		this.parentWhileStmt = parentWhileStmt;
	}
	public WhileStatement getParentWhileStmt() {
		return parentWhileStmt;
	}
	...
	public void setWhileList(List<WhileStatement> whileList) {
		this.whileList = whileList;
	}
	public List<WhileStatement> getWhileList() {
		return whileList;
	}
