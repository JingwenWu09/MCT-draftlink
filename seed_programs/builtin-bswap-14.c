...
__attribute__((noinline, noclone)) static long long rt64(long long x, int y, long long z) {
  return (__builtin_bswap64(x) >> y) & z;
}

void TEST64(int X, int Y, int Z) {
